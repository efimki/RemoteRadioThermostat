...
public class Ds18b20 implements AutoCloseable {
     ...
     * @throws IOException
     */
    public Ds18b20(String bus) throws IOException {
     ...
     * @throws IOException
     */
    public Ds18b20(String bus, int address) throws IOException {
     ...
     * @throws IOException
     */
    /*package*/  Ds18b20(I2cDevice device) throws IOException {
        connect(device);
    }
